  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start">
      <div className="ml-[20px] md:ml-[175px] mt-[20px] md:mt-[40px] flex-1">
        <h1
          className="text-[32px] md:text-[64px] font-extrabold lg:text-left
         w-[350px] lg:w-[614px] md:w-[40px] leading-[36px] md:leading-[64px] ml-20 lg:ml-0 "
        >
        ...
        <div className="flex flex-col md:flex-row items-center mt-8 space-y-4 md:space-y-0 md:space-x-8">
          ...
          <div className="flex flex-col items-center">
            <Button
              button="Watch Video"
              className="text-white rounded-md w-[150px]  bg-red-500 hover:bg-white hover:text-black border-2 border-red-500"
            />
